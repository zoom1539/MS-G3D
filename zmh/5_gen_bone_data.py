...
bone_pairs = {
    ...
    'zjlab_action': (
        (0, 0), (1, 0), (2, 0), (3, 1), (4, 2), (5, 17), (6, 17), (7, 5), (8, 6), (9, 7), (10, 8),
        (11, 17), (12, 17), (13, 11), (14, 12), (15, 13), (16, 14), (17, 0)
    )
}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default = 'zjlab_action',choices=['ntu', 'ntu120', 'kinetics'])
    ...
    for benchmark in benchmarks[args.dataset]:
        for part in parts:
            ...
            try:
                data = np.load('/data1/zhumh/zjlab_actions/train_data/{}_data_joint.npy'.format(part), mmap_mode='r')
                N, C, T, V, M = data.shape
                fp_sp = open_memmap(
                    '/data1/zhumh/zjlab_actions/train_data/{}_data_bone.npy'.format(part),
                    dtype='float32',
                    mode='w+',
                    shape=(N, 3, T, V, M))
